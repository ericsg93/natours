...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXJpY2tzZzkzIiwiYSI6ImNrY2JhaW51OTFvenQyd3FwYjZuZmY0b3IifQ.MGDwMEF8fMzWyFjupiCXeQ';
  var map = new mapboxgl.Map({
    container: 'map',
    //id que coincide con el id de html
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //variable map definida arriba
    //Add popup
...
exports.showAlert = exports.hiddenAlert = void 0;

/* eslint-disable */
var hiddenAlert = function hiddenAlert() {
...
exports.hiddenAlert = hiddenAlert;
...
var stripe = Stripe('pk_test_51H3qPuCDQVNUOdceOkE8xx4HCRxLILDxMcg60AcPlCvEINBgg3PHKkdW7NCJkDsF5WuoLTwD1mM9KFKQJbH8r7HU00sg0OBHYP');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //el sistema quita el '-' al data-tour-id entonces es tourId
